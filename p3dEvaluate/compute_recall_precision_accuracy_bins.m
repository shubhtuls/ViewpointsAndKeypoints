...
function [recall, precision, accuracy, ap, aa] = compute_recall_precision_accuracy_bins(cls, vnum_train, vnum_test,methodId)
...
filename = sprintf('data/%s_%d_%s.mat', methodId, vnum_train, cls);
